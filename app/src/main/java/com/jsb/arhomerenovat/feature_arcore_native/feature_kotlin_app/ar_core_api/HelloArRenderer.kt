...
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.Framebuffer
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.GLError
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.Mesh
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.Shader
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.Texture
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.VertexBuffer
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.arcore.BackgroundRenderer
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.arcore.PlaneRenderer
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.samplerender.arcore.SpecularCubemapFilter
import com.google.ar.core.exceptions.CameraNotAvailableException
import com.google.ar.core.exceptions.NotYetAvailableException
import com.jsb.arhomerenovat.R
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.helpers.DisplayRotationHelper
import com.jsb.arhomerenovat.feature_arcore_native.feature_java_helper.helpers.TrackingStateHelper
...
class HelloArRenderer(val activity: HelloArActivity) :
  ...
  private var showMessageCallback: ((String) -> Unit)? = null
  ...
  override fun onDrawFrame(render: SampleRender) {
    ...
    wrappedAnchors.filter { it.anchor.trackingState == TrackingState.TRACKING }) {
      ...
      // Apply scaling
//      Matrix.scaleM(modelMatrix, 0, activity.scaleFactor, activity.scaleFactor, activity.scaleFactor)
//
//      // Apply rotation (around Y-axis)
//      Matrix.rotateM(modelMatrix, 0, activity.rotationAngle, 0f, 1f, 0f)
//
//      // Apply translation
////      Matrix.translateM(modelMatrix, 0, activity.deltaX, activity.deltaY, 0f)
//      Matrix.translateM(
//        modelMatrix, 0,
//        activity.deltaX,
//        -activity.deltaY, // Note: Y is inverted (screen vs world coordinates)
//        0f
//      )
      // ====== NEW CODE ENDS HERE ======
  ...
  private fun handleTap(frame: Frame, camera: Camera) {
    ...
    val tap = (activity as HelloArActivity).tapHelper.poll() ?: return
